...
To evaluate the effect of different batch sizes on the validation accuracy of our model, we trained our implementation of ResNet with batch sizes of 2, 8, 32, 64, 128 and 512. We chose the Adam optimizer with a learning rate of $10^{-5}$.

The results can be seen in Figure \ref{fig:batch_size}. As expected, when training with smaller batch sizes, we can observe much faster convergence.
