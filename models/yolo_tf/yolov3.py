...
def yolo_v3(inputs):
    ...
    inputs = layers.conv_layer(name="conv_07", inputs=inputs, filters=256, kernel_size=1, batch_normalize=True)
    ...
    inputs = layers.conv_layer(name="conv_15", inputs=inputs, filters=128, kernel_size=1, batch_normalize=True)
